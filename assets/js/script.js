...
document.addEventListener('visibilitychange',
    function () {
        if (document.visibilityState === "visible") {
            document.title = "Sai Kira Portfolio";
...
var typed = new Typed(".typing-text", {
    strings: ["Machine Learning", "Full Stack Development", "Deep Learning", "Computer Vision","Natural Language Processing", "App Development", "Content Writing"],
    loop: true,
    typeSpeed: 50,
    backSpeed: 25,
    backDelay: 500,
